...
- (void) viewDidLoad
{
    ...
    self.dataSource = [NSArray arrayWithObjects:
                       ...
                       [NSArray arrayWithObjects:@"Получатель:", [self noneNilString:self.penalty.recipient.account], nil],
                       [NSArray arrayWithObjects:@"Счет:", [self spacedCheckString: [NSString stringWithFormat:@"%@", self.penalty.uid]], nil],
